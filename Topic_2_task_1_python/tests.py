...
class TestMaxCost(unittest.TestCase):
    ...
    def test_buyer_can_pay_exact(self):
        ...
        self.assertEqual(count_max_cost_1(buyer, seller), 14)
        self.assertEqual(count_max_cost_2(buyer, seller), 14)
    ...
    def test_no_seller_coins(self):
        ...
        self.assertEqual(count_max_cost_1(buyer, seller), 6)
        self.assertEqual(count_max_cost_2(buyer, seller), 6)
    ...
    def test_all_payments_possible(self):
        ...
        self.assertIsNone(count_max_cost_1(buyer, seller))
        self.assertIsNone(count_max_cost_2(buyer, seller))
    ...
    def test_large_values(self):
        ...
        self.assertEqual(count_max_cost_1(buyer, seller), 149)
        self.assertEqual(count_max_cost_2(buyer, seller), 149)
    ...
    def test_no_possible_payment(self):
        ...
        self.assertEqual(count_max_cost_1(buyer, seller), 4)
        self.assertEqual(count_max_cost_2(buyer, seller), 4)
